<<<<<<< HEAD
# Barra de Navegação Neumorphism

Menu de navegação com aparência neumorphic, sombras suaves e estados de hover.
...
O projeto usa neumorphism com sombras claras e escuras.
...
- HTML5
- CSS3
>>>>>>> fa652b0 (Add README for NavigationBarNeumorphism)
